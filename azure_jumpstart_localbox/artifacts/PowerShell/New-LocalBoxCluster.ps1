...
azcopy cp 'https://azlocalvhds.blob.core.windows.net/images/AzLocal2510.vhdx' "$($LocalBoxConfig.Paths.VHDDir)\AzL-node.vhdx" --recursive=true --check-length=false --log-level=ERROR
